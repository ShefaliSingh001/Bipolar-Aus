  ...
  return (
    <section className="border-y border-border bg-muted/40">
      <div className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="mt-14">
          {achievements.map((a) => (
            <div key={a.figure} className="grid gap-3 border-b border-border py-9 md:grid-cols-[0.45fr_1fr] md:gap-10">
              <div>
                <p className="font-heading text-[38px] leading-none text-primary md:text-[46px]">{a.figure}</p>
